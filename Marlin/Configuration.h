...
#define Z2_DRIVER_TYPE TMC2209  //RASCAL default commented, needed for Z_STEPPER_AUTO_ALIGN in Configuration_adv.h, E1 should be used for Z2
 ...
 */
#define PROBE_MANUALLY // RASCAL default commented - selected for LCD_BED_LEVELING
...
#define PREHEAT_BEFORE_PROBING // RASCAL default commented
...
#define LCD_BED_TRAMMING // RASCAL default commented

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 39, PROBING_MARGIN, 39, PROBING_MARGIN } // (mm) Left, Front, Right, Back insets  // RASCAL
  // RASCAL L & R = absolute(X NOZZLE_TO_PROBE_OFFSET(-39)), F & B = absolute(PROBING_MARGIN (15)) // RASCAL notes
  //#define BED_TRAMMING_INSET_LFRB { 30, 30, 30, 30 } // (mm) Left, Front, Right, Back insets // RASCAL default
...
//  - Boot the display and wait for the update to complete.
//
//#define DGUS_LCD_UI_ORIGIN // RASCAL default is uncommented. Comment out for REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER
