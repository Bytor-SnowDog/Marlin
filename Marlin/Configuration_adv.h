...
#define NO_AUTO_ASSIGN_WARNING // RASCAL to suppress warning ^^^ recommended by compiler
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 10   // Number of iterations to apply during alignment // RASCAL default 5
...
#define ASSISTED_TRAMMING // RASCAL default commented
   ...
   */
  #define TRAMMING_SCREW_THREAD 40 // RASCAL default 30
 ...
 */
//#define INPUT_SHAPING_X // RASCAL default commented
//#define INPUT_SHAPING_Y // RASCAL default commented
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING // RASCAL default commented
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA // RASCAL default commented
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // RASCAL default commented
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu // RASCAL default commented
 ...
 */
#define BABYSTEPPING // RASCAL default commented
...
#define LIN_ADVANCE // RASCAL - not working well - Keep trying to learn more
    ...
    #define ADVANCE_K { 0.0 }     // (mm) Compression length per 1mm/s extruder speed, per extruder // RASCAL default 0.6
  #else
    #define ADVANCE_K 0.0         // (mm) Compression length applying to all extruders // RASCAL default 0.6
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract. // RASCAL default = 5, use 2 for direct drive extruder
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     10  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) The length of filament for a complete unload. // RASCAL default = 700, use 100 for direct drive extruder
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle. // RASCAL default = 670, use 0 for direct drive extruder
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.5  // Scales down the holding current from run current // RASCAL default uncommented and 0.5
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       700        // (mA) RMS current. Multiply by 1.414 for peak current. // RASCAL default 800
    ...
    #define Y_CURRENT       700  // RASCAL default 800
    ...
    #define E0_CURRENT      800 // RASCAL default 800, Hemera recommends 1000, rating is 1330 max.
  ...
  #define DIAG_JUMPERS_REMOVED // RASCAL - added line -> #warning "Motherboard DIAG jumpers must be removed when SENSORLESS_HOMING is disabled. (Define DIAG_JUMPERS_REMOVED to suppress this warning.)"
 ...
 */
#define HOST_ACTION_COMMANDS // RASCAL default commented, found BTT Github solution to uncomment this - trying now
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback // RASCAL default commented, found BTT Github solution to uncomment this - trying now
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications // RASCAL default commented
  #endif
